...
def _short_location(location_full: str) -> str:
    ...
    `location` itself starts with a site code (`TESTDC2`, `TESTDC1`,
    etc.) joined by underscore: `"TESTDC2_B2_G4-G-06-41"` ->
...
def _base_ticket(ticket_number: str) -> str:
    """`"SHGD0009000005#2"` -> `"SHGD0009000005"` (strip the #N sub-block suffix)."""
